package com.lucasferraz.medicalconsult.consulta.services;

import com.lucasferraz.medicalconsult.consulta.domain.Consulta;
import com.lucasferraz.medicalconsult.consulta.exception.ExceptionDataIntegrityViolation;
import com.lucasferraz.medicalconsult.consulta.repository.ConsultaRepository;
...
public class ConsultaService {
    ...
    public void deletarConsulta(Long id) {
        ...
        try {
            ...
            throw new ExceptionDataIntegrityViolation("Não é possível excluir, porque há entidades relacioandas.");
        }
